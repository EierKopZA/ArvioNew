...
- Improved source switching, playback controls, stream startup, trailer handling, loading clearlogo polish, and source loading from fast Search-to-Details navigation. Contributors: Sage Gavin Davids, Himanth Reddy, and ARVIO maintainers; MR submitted by Eier Kop.
...
### Contributors
- Sage Gavin Davids: player source switching, loading clearlogo polish, regex filter TV focus, details metadata behavior, watchlist topbar/grid focus, IMDb-ID wait for faster Details source reliability.
...
- Eier Kop: submitted the watchlist navigation and Search-to-Details source loading MRs.
